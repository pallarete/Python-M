...
entre la mente y el fuego está en equilibrio y la función debe retornar True.
...
def equilibrio(cadena):
  ...
  contador_j = cadena_min.count('j')
  contador_r = cadena_min.count('r')
  print(f'letra_r:{contador_r} , letra_j: {contador_j}')
  return  contador_j == contador_r


print( equilibrio('rio'))
print( equilibrio('Trio'))
print( equilibrio('RRrrJJjj'))
print( equilibrio('julio'))
print( equilibrio('jazmin'))
print( equilibrio('jorge'))
print( equilibrio('paco'))
